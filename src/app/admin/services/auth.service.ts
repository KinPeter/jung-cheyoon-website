...
export class AuthService {
  ...
  public tryAutoLogin(): void {
    const rawData: string | null = sessionStorage.getItem('ch-adminauth');
    if (rawData) {
  ...
  private handleLogin(res: LoginResponse): void {
    ...
    sessionStorage.setItem('ch-adminauth', JSON.stringify(this.authData.value));
  ...
  public logout(): void {
    ...
    sessionStorage.removeItem('ch-adminauth');
    clearTimeout(this.logoutTimer);
  }
}
