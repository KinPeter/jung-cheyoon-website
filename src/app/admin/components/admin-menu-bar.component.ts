  ...
  template: `
    <div *ngIf="!isLoginPage()" class="admin-menu-bar">
      <div class="admin-menu-bar__left">
        ...
        |
        <a routerLink="/admin/filters" [class.admin-link_active]="isActive('/admin/filters')">
          Filters
        </a>
        |
        <a routerLink="/admin/portfolio" [class.admin-link_active]="isActive('/admin/portfolio')">
          Portfolio
        </a>
      </div>
